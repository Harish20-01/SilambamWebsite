      ...
      >
        ...
        <div className={`trainer-info ${showMore ? 'expanded-text' : ''}`}>
          ...
          {!showMore && (
            <>
              <motion.p whileHover={{ x: 5 }}>
                <strong>மூல ஊர்:</strong> சதாசிவபுரம், தலைவாசல், சேலம் மாவட்டம்
              </motion.p>
              <motion.p whileHover={{ x: 5 }}>
                <strong>கொள்கை:</strong> தமிழர்க் கலைகள் கற்போம்! தமிழர் மரபை மீட்போம்!!
              </motion.p>
            </>
          )}
          ...
          {showMore && (
            <>
              ...
              <motion.p whileHover={{ x: 5 }}>
                மேலும், சுற்றியுள்ள ஆத்தூர், கெங்கவல்லி, கடம்பூர், மணிவிழுந்தான், சம்பேரி உள்ளிட்ட பல கிராமங்களில் கிளைப்பள்ளிகள் அமைத்து மாணவர்களுக்கு பயிற்சி அளிக்கிறார்.
              </motion.p>
              ...
              <motion.p whileHover={{ x: 5 }}>
                இவரால் பயிற்றுவிக்கப்பட்ட மாணவர்கள் பலர் அரசு போட்டிகளில் வென்று, விளையாட்டுத்துறை இட ஒதுக்கீட்டுச் சலுகையைப் பெற்றுள்ளனர்.
              </motion.p>

              <motion.p whileHover={{ x: 5 }}>
                தற்போது இவர் மற்றும் இவரால் பயிற்றுவிக்கப்பட்ட ஆசிரியர்கள் மூலம் 10க்கும் மேற்பட்ட தனியார் கல்வி நிறுவனங்களில் சிலம்பம், மல்லர்க்கம்பம் போன்ற கலைகள் பயிற்சி அளிக்கப்படுகின்றன.
              </motion.p>
            </>
          )}
        </div>
